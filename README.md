...
│
├── data/                               
│   ├── customers_raw.csv               # Input data file (provided)
│   ├── products_raw.csv                # Input data file (provided)
│   ├── sales_raw.csv                   # Input data file (provided)
│   ├── customers_clean.csv             # Output data file (Generated by ETL script)
│   ├── products_clean.csv              # Output data file (Generated by ETL script)
│   └── sales_clean.csv                 # Output data file (Generated by ETL script)
│
├── part1-database-etl/
